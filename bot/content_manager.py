...
#            CM_EPISODE_SEND_FILE: [MessageHandler(filters.VIDEO() | filters.Document.ALL, cm_ep_receive_file)],
            CM_EPISODE_SEND_FILE: [MessageHandler(filters.ATTACHMENT, cm_ep_receive_file)],
